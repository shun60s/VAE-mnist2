...
class Visualize():
    def __init__(self, z_dim, dataloader_test, model, device, digit_number):
        """Constructor
    ...
    def createDirectories(self):
        ...
        Returns:
            None.
        """
        if not os.path.exists(f"./images/reconstruction_{self.digit_number}"):
            os.makedirs(f"./images/reconstruction_{self.digit_number}")
        if not os.path.exists(f"./images/latent_space_{self.digit_number}"):
            os.makedirs(f"./images/latent_space_{self.digit_number}")
        if not os.path.exists(f"./images/lattice_point_{self.digit_number}"):
            os.makedirs(f"./images/lattice_point_{self.digit_number}")
        if not os.path.exists(f"./images/walkthrough_{self.digit_number}"):
            os.makedirs(f"./images/walkthrough_{self.digit_number}")
    ...
    def reconstruction(self):
        ...
        for num_batch, data in enumerate(self.dataloader_test):
            ...
            fig.savefig(f"./images/reconstruction_{self.digit_number}/z_{self.z_dim}_{num_batch}.png")
            plt.close(fig)
    ...
    def latent_space(self):
        ...
        for num_batch, data in enumerate(self.dataloader_test):
            ...
            fig_plot.savefig(f"./images/latent_space_{self.digit_number}/z_{self.z_dim}_{num_batch}_plot.png")
            fig_scatter.savefig(f"./images/latent_space_{self.digit_number}/z_{self.z_dim}_{num_batch}_scatter.png")
            plt.close(fig_plot)
    ...
    def lattice_point(self):
        ...
        fig.savefig(f"./images/lattice_point_{self.digit_number}/z_{self.z_dim}.png")
        plt.close(fig)
    ...
    def walkthrough(self):
        ...
        for n in range(len(y1_to_y2_list)):
            ...
            animation.save(f"./images/walkthrough_{self.digit_number}/z_{self.z_dim}_{n}.gif", writer="pillow")
            plt.close(fig)
